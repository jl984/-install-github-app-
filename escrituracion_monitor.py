...
GMAIL_CONTRASENA = "qkjk ytzy mvwi cpjv"       # ← Reemplaza con la contraseña real de tu correo imodelo.cl
EQUIPO_EMAILS    = [
...
EXCEL_PATH    = r"C:\Users\Casa\OneDrive\01 Ronald Game Valdés\04 Inmobiliaria Paicaví  SpA\01 OPERACIONES\Escrituración\Tres_Pascualas_APARTMENTS_INTEGRADA (1).xlsx"
...
def generar_detalle_xlsx(op_num, df):
    ...
    sc(ws, "C29", f"ESTACIONAMIENTO DE BICICLETA N° {bici}" if bici else "ESTACIONAMIENTO DE BICICLETA N°",
...
<body><div class="wrap">
  ...
  <div class="foot">INMOBILIARIA MODELO | www.imodelo.cl — Sistema automático de escrituración</div>
    ...
    # Gmail / Google Workspace — SMTP SSL puerto 465
